...
const initHome = () => {
    ...
    appendElem(hiBlock, "p", ["gray-text"], "Here are some suggestions to stay mentally healthy.");
...
const initTest = () => {
    const content = clearContent();
    appendElem(content, "p", ['big-header'], "Mental disorders");
...
const initAbout = () => {
    ...
    const articleContent = [
        "Not surprisingly, the coronavirus pandemic and resulting economic \
         downturn have taken a toll on the mental health of adults of all ages.A majority of adults 18 and older (53%) said \
...
const initWelcomePage = () => {
    ...
    appendElem(regWrapper, "p", ['slight-header', 'big-header'], "WeCare");
    appendElem(regWrapper, "p", [], "What do you call yourself?");
    const nameInput = appendElem(regWrapper, "input", ['input-general'], "");
    appendElem(regWrapper, "p", [], "What is your age?");
    ...
    const registerButton = appendElem(regWrapper, "div", ['action-button'], "GO !");
